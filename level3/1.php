...
<br>
    <form action="" method="post">
        <tr>
            <td><label for="username">Input bilangan ke-1 </label></td>
            <td><input type="number" name="bilangan1" ></td>
        </tr>
        <tr>
            <td><label for="password">Input bilangan ke-2  </label></td>
            <td><input type="number" name="bilangan2" ></td>
        </tr>
        <tr>
            <td><label for="password">Input bilangan ke-3 </label></td>
